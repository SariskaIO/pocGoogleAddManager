...
class YouTubeAdCompositor:
    ...
    def _create_main_pipeline(self):
        ...
        """
        log("Creating Headless Pipeline (RTMP Only) with YouTube optimized settings...")
    ...
    def run(self):
        Gtk.init(None)
        log("Starting YouTube Ad Sync POC...")
...
if __name__ == "__main__":
    STREAM_KEY = "dq80-9c3r-8y9a-rjtm-6fj3"
    HLS_URL = "https://indiatodaylive.akamaized.net/hls/live/2014320/indiatoday/indiatodaylive/live_720p/chunks.m3u8"
    ...
    player = YouTubeAdCompositor(main_url=HLS_URL, stream_key=STREAM_KEY, ad_urls=ads, ad_positions=positions)
    player.run()
